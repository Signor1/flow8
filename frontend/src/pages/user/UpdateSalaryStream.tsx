    ...
    return (
        <main className="w-full h-full flex flex-col gap-4 mt-10 ml-2 pr-2">
            <div className="w-full flex flex-col gap-2">
                <h1 className="md:text-4xl text-2xl text-color5 font-belanosima">Update Your Salary Distribution</h1>
                <p className="text-gray-500 font-barlow md:text-lg lg:w-[70%] md:w-[80%] w-full">Effortlessly manage your employee salaries with precision and ease using Triver's Salary Distribution Setup</p>
            </div>
