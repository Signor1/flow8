...
export const useGetOPBalance = (address: any) => {
    ...
    useEffect(() => {
        ...
        wssProvider.getLogs({ ...depositfilter, fromBlock: 21791531 }).then((events) => {
        ...
        wssProvider.getLogs({ ...withdrawfilter, fromBlock: 21791531 }).then((events) => {
        ...
        wssProvider.getLogs({ ...feefilter, fromBlock: 21791531 }).then((events) => {
        ...
        wssProvider.getLogs({ ...subfilter, fromBlock: 21791607 }).then((events) => {
